...
class LLM:
    def __init__(self, model='gpt35', temperature=0.3,
                 key="sk-1MC0MeD3zZDrI0m3xlCAkR8pZHlGlAcgUy0n1hqM5IFM8gO8", prompt=None):
        self.history = []
        self.client = OpenAI(
            api_key=key,
    ...
    # query interface
    def query(self, sentence, context=True, n=1):
